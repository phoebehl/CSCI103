...
**
** Created: Mon May 5 02:19:37 2014
...
const QMetaObject GUIPlayer::staticMetaObject = {
    { &PlayerGUI::staticMetaObject, qt_meta_stringdata_GUIPlayer,
...
void *GUIPlayer::qt_metacast(const char *_clname)
{
    ...
    return PlayerGUI::qt_metacast(_clname);
}

int GUIPlayer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = PlayerGUI::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
